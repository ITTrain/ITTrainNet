...
/*Table structure for table `EDU_DOWNLOAD` */
DROP TABLE IF EXISTS `EDU_DOWNLOAD`;

CREATE TABLE `EDU_DOWNLOAD` (
  `FILE_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '文件ID',
  `FILE_URL` varchar(200) DEFAULT NULL COMMENT '文件路径',
  `FILE_NAME` varchar(200) DEFAULT NULL COMMENT '文件名称',
  `TYPE1` varchar(2) DEFAULT NULL COMMENT '文件分类1',
  `TYPE2` varchar(2) DEFAULT NULL COMMENT '文件分类2',
  `TITLE` varchar(200) DEFAULT NULL COMMENT '文件下载标题',
  `AUTHORITY` varchar(10) DEFAULT NULL COMMENT '文件访问权限',
  `CREATE_TIME` timestamp NULL DEFAULT NULL COMMENT '文件创建时间',
  `SUBJECT_ID` int(11) DEFAULT '0' COMMENT '专业ID',
  `CLICK_NUM` int(11) DEFAULT '0' COMMENT '文件下载量',
  `SORT` int(11) DEFAULT '0' COMMENT '排序值',
  PRIMARY KEY (`FILE_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='下载文件表';

/*Table structure for table `EDU_JAPANESE_WORDS */
DROP TABLE IF EXISTS `EDU_JAPANESE_WORDS`;

CREATE TABLE `EDU_JAPANESE_WORDS` (
  `WORD_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '单词ID',
  `LESSON` varchar(50) DEFAULT NULL COMMENT '课程',
  `KANA` varchar(200) DEFAULT NULL COMMENT '假名',
  `KANJI` varchar(200) DEFAULT NULL COMMENT '汉字',
  `CHINESE` varchar(200) DEFAULT NULL COMMENT '中文',
  `ENGLISH` varchar(200) DEFAULT NULL COMMENT '英语',
  `WORD_TYPE` varchar(20) DEFAULT NULL COMMENT '词形',
  `TYPE1` varchar(50) DEFAULT NULL COMMENT '领域分类1',
  `TYPE2` varchar(50) DEFAULT NULL COMMENT '领域分类2',
  `SUBJECT_ID` int(11) DEFAULT '0' COMMENT '专业ID',
  `DISPLAY_FLG` int(11) DEFAULT '0' COMMENT '表示フラグ',
  PRIMARY KEY (`WORD_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='IT日语词汇';
